...
*/
  ...
  const char *custom_serial = "MYSTM32G431";
      // Fill USBD_StringSerial[2..] with Unicode (UTF-16LE) version of custom_serial
      for (int i = 0; i < 10; ++i) {
          USBD_StringSerial[2 + i * 2] = custom_serial[i];
          USBD_StringSerial[3 + i * 2] = 0;
      }
